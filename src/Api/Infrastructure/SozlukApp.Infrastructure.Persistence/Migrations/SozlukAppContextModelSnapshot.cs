...
namespace SozlukApp.Infrastructure.Persistence.Migrations
{
    ...
    partial class SozlukAppContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SozlukApp.Api.Domain.Models.EmailConfirmation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("SozlukApp.Api.Domain.Models.Entry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SozlukApp.Api.Domain.Models.EntryComment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SozlukApp.Api.Domain.Models.EntryVote", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SozlukApp.Api.Domain.Models.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SozlukApp.Api.Domain.Models.Entry", b =>
                {
                    b.HasOne("SozlukApp.Api.Domain.Models.User", "CreatedBy")
                        .WithMany("Entries")
            ...
            modelBuilder.Entity("SozlukApp.Api.Domain.Models.EntryComment", b =>
                {
                    ...
                    b.HasOne("SozlukApp.Api.Domain.Models.Entry", "Entry")
                        .WithMany("EntryComments")
            ...
            modelBuilder.Entity("SozlukApp.Api.Domain.Models.EntryCommentFavorite", b =>
                {
                    b.HasOne("SozlukApp.Api.Domain.Models.User", "CreatedUser")
                        .WithMany("EntryCommentFavorites")
                        .HasForeignKey("CreatedById")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("SozlukApp.Api.Domain.Models.EntryComment", "EntryComment")
                        .WithMany("EntryCommentFavorites")
